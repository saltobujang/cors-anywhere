...
function getHandler(options, proxy) {
  var corsAnywhere = {
    ...
    originWhitelist: ['https://ruby8000.slot-server-rusia.gift.org.sg/', 'http://127.0.0.1:5500/'],            // If non-empty, requests not from an origin in this list will be blocked.
